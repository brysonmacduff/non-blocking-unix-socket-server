...
{
class NonBlockingUnixDomainSocketServerTest : public ::testing::Test
{
protected:
...
*/
TEST_F(NonBlockingUnixDomainSocketServerTest, Constructor)
{
    NonBlockingSocketServer server(m_unix_socket_path);
}

/*
    This test checks that one client can connect and disconnect correctly
*/
TEST_F(NonBlockingUnixDomainSocketServerTest, MonitorConnection)
{
    ...
    std::thread client_thread(&NonBlockingUnixDomainSocketServerTest::ConnectorClient,this,m_unix_socket_path,std::ref(client_close_condition),[&](){
...
*/
TEST_F(NonBlockingUnixDomainSocketServerTest, SendAndReceivePayload_OneClient)
{
    NonBlockingSocketServer server(m_unix_socket_path);
    ...
    std::thread client_thread(&NonBlockingUnixDomainSocketServerTest::ReaderSenderClient
    ,this
    ,m_unix_socket_path
    ,[]()
    {
...
*/
TEST_F(NonBlockingUnixDomainSocketServerTest, SendAndReceivePayload_TwoClients)
{
    const uint client_count = 2;
    NonBlockingSocketServer server(m_unix_socket_path,client_count);
    ...
    std::thread client_thread1(&NonBlockingUnixDomainSocketServerTest::ReaderSenderClient
    ,this
    ,m_unix_socket_path
    ,[]()
    {
    ...
    std::thread client_thread2(&NonBlockingUnixDomainSocketServerTest::ReaderSenderClient
    ,this
    ,m_unix_socket_path
    ,[]()
    {
